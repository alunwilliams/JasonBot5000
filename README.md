...
Jason is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running Jason Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start Jason locally by running:
...
Then you can interact with Jason by typing `Jason help`.

    Jason> Jason help
    Jason animate me <query> - The same thing as `image me`, except adds [snip]
    Jason help - Displays all of the help commands that Jason knows about.
    ...
